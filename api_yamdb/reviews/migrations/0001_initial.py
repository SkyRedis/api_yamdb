# Generated by Django 3.2 on 2023-01-21 18:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='review', to='reviews.review', verbose_name='ID отзыва')),
            ],
            options={
                'ordering': ['-pub_date'],
            },
